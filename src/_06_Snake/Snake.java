...
public class Snake {
	...
	public void update() {
		...
		int nextx = getHeadLocation().x;
		int nexty = getHeadLocation().y;
		...
		snake.get(0).setLocation(nextLoc);
	...
	public boolean isOutOfBounds() {
		...
		//   and false otherwise
		if(getHeadLocation().x<0||getHeadLocation().x>750||getHeadLocation().y<0||getHeadLocation().y>600)
			return true;
		return false;
	}
